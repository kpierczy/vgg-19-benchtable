...
# @modified   Sunday, 26th June 2022 4:44:56 pm
# @project    vgg-19-testbench
# @brief      Set of auxiliary function for plot-neural-net module use by the pipe/pipe.py script to visualize the VGG19 input pipe
...
# Conv
def to_Conv( name, s_filer=256, n_filer=64, offset="(0,0,0)", to="(0,0,0)", width=1, height=40, depth=40, caption=" ", colour="\ConvColor" ):
    return r"""
